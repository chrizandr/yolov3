...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/soccer.cfg', help='cfg file path')
    parser.add_argument('--data-cfg', type=str, default='data/coco.data', help='coco.data file path')
    parser.add_argument('--weights', type=str, default='weights/latestsports_synth.pt', help='path to weights file')
